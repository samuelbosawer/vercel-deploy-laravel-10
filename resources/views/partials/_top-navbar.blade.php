    ...
    <div class="container-fluid">
        ...
        <div class="logo-box">
            <a href="index.html" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img src="{{asset('assets/images/logo-sacode-adminpanel-sm.png')}}" alt="" height="22">
                    <!-- <span class="logo-lg-text-light">UBold</span> -->
                </span>
                <span class="logo-lg">
                    <img src="{{asset('assets/images/logo-sacode-adminpanel-dark.png')}}" alt="" height="20">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-xl-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="{{url('./admin/contributors/create')}}" class="dropdown-item">
                        <i class="fe-user-check mr-1"></i>
                        <span>Contributor</span>
                    </a>

                    <!-- item-->
                    <a href="{{url('./admin/forum/create')}}" class="dropdown-item">
                        <i class="fe-message-square mr-1"></i>
                        <span>Forum</span>
                    </a>

                    <!-- item-->
                    <a href="{{url('./admin/donation/create')}}" class="dropdown-item">
                        <i class="fe-pocket mr-1"></i>
                        <span>Donation</span>
                    </a>

                    <!-- item-->
                    <a href="{{url('./admin/course/create')}}" class="dropdown-item">
                        <i class="fe-book-open mr-1"></i>
                        <span>Course</span>
                    </a>

                    <!-- item-->
                    <a href="{{url('./admin/blog/create')}}" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="{{url('./admin/sacodesweekends/create')}}" class="dropdown-item">
